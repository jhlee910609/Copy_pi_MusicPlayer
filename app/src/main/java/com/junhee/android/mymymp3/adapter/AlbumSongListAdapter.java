...
public class AlbumSongListAdapter extends RecyclerView.Adapter<AlbumSongListAdapter.ViewHolder> {
    ...
    private AlbumSongListFragment.OnAlbumSongListener onAlbumSongListener;

    // TODO 데이터를 받아와서 셋팅하는 변수와 로직을 만든다. 어차피 어댑터가 할 일이기 때문에
    public AlbumSongListAdapter(List<Music.Item> items, AlbumSongListFragment.OnAlbumSongListener listener) {
        this.datas = items;
        this.onAlbumSongListener = listener;
    }
...
//        }
    ...
    public void goDetail(int position) {
        ...
        onAlbumSongListener.goDetailInteraction(position);
    }
        ...
        public ViewHolder(View view) {
            ...
            mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    onAlbumSongListener.setMainPlayer(datas.get(position));
